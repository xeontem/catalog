...
//-------------------------- peregruz oborud ----------------------------
import peregruz_oborud from '../img/peregr_oborud.jpg';
...
export const CATALOG_PRODUCTS = [
  ...
  {path:'/complect',        img: rolprot_img,      descrExtended: ITEM_DESCR.rollets_extended,           descrShort: ITEM_DESCR.rollets_short,           label: "Комплектующие"},
  ...
  {path:'/panoram_vorota',  img: panoramvorot_img, descrExtended: ITEM_DESCR.panoramnye_vorota_extended, descrShort: ITEM_DESCR.panoramnye_vorota_short, label: "Панорамные ворота"},
  ...
  {path:'/peregruz_oborud', img: peregruz_oborud,  descrExtended: ITEM_DESCR.rollets_extended,           descrShort: ITEM_DESCR.rollets_short,           label: "Перегрузочное оборудование"},
