    ...
    <ExpansionList className={'md-cell md-cell--12 clear ' + listClass}>
      ...
      <ExpansionPanel headerClassName="panel-header" label="Панорамные ворота AluPro" style={style} footer={null}>
        ...
        <section>
          ...
          <div className="sandwich-images"> 
            <div className="col_l4 col_m6 col_pad"> <img src={CONST.ORIGIN + '/images/product/gate/panoramnye-vorota/pic_23_thumb.jpg'} alt="petlya" title="Тёмный дуб" width="245" height="180"/> 
            </div>
      ...
      <ExpansionPanel headerClassName="panel-header" label="Панорамные ворота AluTherm" style={style} footer={null}>
        ...
        <section>
          ...
          <div className="sandwich-images"> 
            <div className="col_l4 col_m6 col_pad"> <img src={CONST.ORIGIN + '/images/product/gate/panoramnye-vorota/pic_33_thumb.jpg '} alt="petlya" title="Тёмный дуб" width="245" height="180"/> 
            </div>
