...
export const rollets_extended =
          ...
          <p className="heading-3">Защитные роллеты от </p>
            ...
            <p>Наша компания заботится о красоте, безопасности и уюте домов, офисов и других объектов, предлагая эстетичные и надежные рольставни – специальные защитные конструкции из алюминиевых профилей, предназначенные для окон и дверей.</p>
          ...
          <p className="heading-3"><b>Для покупки качественных и красивых роллет на окна нужно сделать 7 простых шагов:</b></p>
            ...
            <p>Чтобы не ошибиться в качестве изделия, посмотрите следующую видеоподборку  с советами по выбору рольставен.</p>
          ...
          <p className="heading-3">Качественные оконные рольставни для красивой и комфортной жизни</p>
            <p>Изготавливая роллеты, мы контролируем свыше 50 характеристик, применяя для этого 40 методов проверки качества. В результате отличные характеристики позволяют им соответствовать национальным и международным стандартам качества и безопасности, а расширенная цветовая гамма, большой выбор профилей и комплектующих – ожиданиям покупателей.</p>
            <p>Роллеты на окна  поставляются в более чем 30 цветах, а также в эксклюзивных цветовых решениях под дерево. Производитель предлагает профили роликовой прокатки 11 типоразмеров и экструдированные профили 5 типоразмеров для изготовления полотна системы. Оконные рольставни также можно дополнить различными защитными коробами: для наружного и встроенного монтажа, 20- и 45-градусными, круглыми или полукруглыми. </p>
            <p>В зависимости от того, насколько активно будет использоваться система, можно выбрать роллеты с ручным или автоматическим управлением.  предлагает решения для любого здания и бюджета: 6 типов ручных механизмов и большой выбор электроприводов и элементов управления.</p>
            <p>Хотите услышать мнение тех, кто уже пользуется оконными роллетами ? Смотрите серию мини-интервью о выборе в пользу качества и эстетики.</p>
